...
class CreateSalePage extends React.Component {
    state = {
        customers: [],
        products: [],
        customer_id: '',
    ...
    componentDidMount(){
        try {
            if(this.props.location.state.product_id){
                axios.get('http://localhost:8000/api/products/' + this.props.location.state.product_id)
                .then(
                    response => {
                        this.setState({
                ...
                <div className='container'>
                    ...
                    <div>
                        <form>
                            ...
                            <div className='mb-3'>
                                <button onClick={() => this.itmaker()} type="button" className="btn btn-sm btn-primary btn-lg">Vender</button>
                            </div>
                        </form>
                    </div>
                    <br/>
